...
- [ ] **Perf-triangulation deferrals (trigger-gated)** — Tier 5.2 / 5.4 / 5.6 / 5.7 / 6.1 / 6.2 from [`audits/2026-05-17-performance-architecture-triangulation.md`](./audits/2026-05-17-performance-architecture-triangulation.md) (closed 2026-05-18; Tier 1-4 + 5.1 / 5.3 / 5.5 shipped). Each ships when its trigger fires:
