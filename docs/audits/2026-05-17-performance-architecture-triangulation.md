...
| ------------ | -------------------------------------------------------------------------------------------------------------------------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------- |
| **Codex**    | [`../../codex-5.3-performance-architecture-audit.md`](../../codex-5.3-performance-architecture-audit.md)                         | Codex 5.3       | Full file-coverage accounting (390 text-read, 22 symlinks); CI surfaces included                                        |
| **Kimi**     | [`../../kimi-k2.5-architecture-performance-audit.md`](../../kimi-k2.5-architecture-performance-audit.md)                         | Kimi K2.5       | Architecture overview heavy; verified all PRAGMA values + worker formula in source                                      |
| **Claude**   | [`../research/claude-opus-4-7-performance-architecture-audit.md`](../research/claude-opus-4-7-performance-architecture-audit.md) | Claude Opus 4.7 | Two `--full --performance` runs measured; standalone `tinyglobby` micro-bench; deepest source coverage (33 files cited) |
| **Composer** | [`../research/composer-performance-architecture-audit.md`](../research/composer-performance-architecture-audit.md)               | Composer        | Section-aware doc reads; deliberate non-duplication baseline for Claude's audit                                         |
| **GPT-5.5**  | [`gpt-5.5-performance-architecture-audit-2026-05-17.md`](./gpt-5.5-performance-architecture-audit-2026-05-17.md)                 | GPT-5.5         | Single `--full --performance` run + full `benchmark.ts` table; surfaced live SQLite-lock warning during audit           |
