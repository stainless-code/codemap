...
| **`file_metrics` / complexity**         | `lib/complexity-fixture.ts` — `large-functions`, `deeply-nested-functions`, `high-complexity-untested`, `high-cognitive-complexity`, `catch_rethrows` heuristics                                                                                        |
...
| **Unresolved import blind spot**        | `lib/alias-blind-spot.ts` — `@codemap-fixture/unresolved-orphan` → `unimported-exports` `unresolved_import_blind_spot` on `orphanHelper`                                                                                                                |
