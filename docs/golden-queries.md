...
| Tier A scenario coverage      | Scenarios cover the core parser / schema surfaces, **all 58 bundled recipes**, and SQL pin-down for substrate tables — see [testing-coverage.md](./testing-coverage.md). Guard: `scripts/query-golden-coverage-matrix.test.mjs`. Inventory: [scenarios.json](../fixtures/golden/scenarios.json). |
