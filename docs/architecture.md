...
| `agents-init.ts` / `agents-init-interactive.ts` / `agents-init-mcp.ts`                            | `codemap agents init` — see [agents.md](./agents.md) (granular template + IDE writes, pointer upsert, **`--interactive`**, **`--mcp`** side-effect JSON merge, `.gitignore`)                                                                                                                                                                                                                                                     |
