...
| Next action          | Detail                                                    |
| -------------------- | --------------------------------------------------------- |
| **Review / merge**   | PR — MCP `affected` tool (Phase 2 follow-up to #132)      |
...
| **5** | [`affected-tests-recipe`](./affected-tests-recipe.md)                                                                         | merged  | [#132](https://github.com/stainless-code/codemap/pull/132)                                                             | 3, 4                              |
