...
| Next action          | Detail                                                                              |
| -------------------- | ----------------------------------------------------------------------------------- |
| **Review / merge**   | PR 4 — trace recipes (`feat/trace-recipes`) when open                               |
...
| **4** | Recipe half of [`mcp-trace-explore-tools`](./mcp-trace-explore-tools.md) (`call-path`, `symbol-neighborhood` SQL + tests)     | open    | `feat/trace-recipes`                                                                                                   | 3, 5                              |
