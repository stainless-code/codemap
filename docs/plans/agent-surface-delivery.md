...
| Next action         | Detail                                                                                    |
| ------------------- | ----------------------------------------------------------------------------------------- |
| **Start next**      | **PR 9** — `agent-eval-harness` (last P1) · open PR for **PR 7** `field-qualified-search` |
...
| **7** | [`field-qualified-search`](./field-qualified-search.md) | open | branch ready | PR 1, PR 6 |
