...
| **Non-goals (v1)** — deliberate product floors (FTS default-off, no LSP shim, predicate-as-API not verdict engine, no one-shot CLI daemon, no deep intent classification)                                                                                                                                                                                                                    | [roadmap.md § Non-goals](./roadmap.md#non-goals-v1)                                      | [why-codemap.md § When to reach for something else](./why-codemap.md#when-to-reach-for-something-else) (consumer-facing framing) — links here; [research/](./research/) notes link here, never re-list    |
