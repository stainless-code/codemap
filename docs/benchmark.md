...
**Log capture (local, no real agent export):** generate entries-style MCP-on/off transcripts from live handlers + the traditional probe, then compare:
