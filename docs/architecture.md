...
| `agents-init.ts` / `agents-init-interactive.ts` | `codemap agents init` — see [agents.md](./agents.md) (templates → `.agents/`, `--interactive`, `.gitignore`, IDE wiring) |
...
**Agent templates:** `codemap agents init` — [agents.md](./agents.md).
