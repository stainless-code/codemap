...
> **Status:** open (tiers **7–13**) · tiers **1–6** shipped at `SCHEMA_VERSION` **34**; **`type_heritage`** (#142) bumped live schema to **35** — see [`architecture.md § Schema`](../architecture.md#schema). Apply-engine direction in [`apply-engine-direction.md`](./apply-engine-direction.md).
>
